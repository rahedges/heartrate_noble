...
var CaloriesCharacteristic = function() {
  CaloriesCharacteristic.super_.call(this, {
   uuid: '9dc17022-8855-11e3-979a-78acc0b8777',
   properties: ['read'],
   value: new Buffer('8943'),
   descriptors: [
    new BlenoDescriptor({
	uuid: '2901',
	value: 'Calories'
...
var AvgHeartRateCharacteristic = function() {
  AvgHeartRateCharacteristic.super_.call(this, {
   uuid: '9dc17032-8855-11e3-979a-78acc0b8777',
   properties: ['read'],
...
var MaxHeartRateCharacteristic = function() {
  MaxHeartRateCharacteristic.super_.call(this, {
   uuid: '9dc17042-8855-11e3-979a-78acc0b8777',
   properties: ['read'],
   value: new Buffer('165'),
   descriptors: [
    new BlenoDescriptor({
    uuid: '2901',
    value: 'HRMax'
...
var MaxSpeedCharacteristic = function() {
  MaxSpeedCharacteristic.super_.call(this, {
   uuid: '9dc17052-8855-11e3-979a-78acc0b8777',
   properties: ['read'],
   value: new Buffer('12'),
   descriptors: [
    new BlenoDescriptor({
...
var AvgSpeedCharacteristic = function() {
  AvgSpeedCharacteristic.super_.call(this, {
   uuid: '9dc17062-8855-11e3-979a-78acc0b8777',
   properties: ['read'],
   value: new Buffer('9'),
   descriptors: [
    new BlenoDescriptor({
...
var Phase = function() {
  Phase.super_.call(this, {
   uuid: '9dc170B2-8855-11e3-979a-78acc0b87777',
   properties: ['read'],
   value: new Buffer('Workout'),
   descriptors: [
    new BlenoDescriptor({
    uuid: '2901',
    value: 'Phase'
...
util.inherits(Phase, BlenoCharacteristic);
