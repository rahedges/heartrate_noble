...
// This is all event driven so move to qml
function Bleno() {
  this.state = 'unknown';

  this._bindings = bindings; // ./linux/bindings
...
// Setting up functions to define service, should they just be imported directly into the file
